...
```{r main_plot, echo=FALSE, fig.width=6, fig.height=2}
...
```{r fermentation_profile, echo=FALSE, fig.width=6, fig.height=1}
dateWindow <- c("2018-03-28", "2018-03-30")
...
fermentation_temp <- annotationstyle(fermentation_temp)
fermentation_temp
```
